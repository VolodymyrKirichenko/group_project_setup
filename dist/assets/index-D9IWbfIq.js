		...
		return (
          ...
          && (Bo(l)
            && (l = vc(
            	l,
            	t
                + (!l.key || (u && u.key === l.key) ? '' : ('' + l.key).replace(ju, '$&/') + '/')
                + e,
            )),
          n.push(l)),
			1
...
function es(e, n, t) {
	...
	for (r in n) {
		_c.call(n, r) && !xc.hasOwnProperty(r) && (l[r] = n[r]);
	}
	...
	(e.unstable_scheduleCallback = function (_, N, z) {
		...
		return (
			...
			z > H
				? ((_.sortIndex = z),
				n(c, _),
				t(s) === null && _ === t(c) && (k ? (f(P), (P = -1)) : (k = !0), yl(h, z - H)))
...
function Lc(e) {
	return Kl.call(Au, e) ? !0 : Kl.call(Uu, e) ? !1 : zc.test(e) ? (Au[e] = !0) : ((Uu[e] = !0), !1);
}
...
function Ac(e, n, t, r, l, o, u, i, s) {
	(Et = !1), (Rr = null), jc.apply(Uc, arguments);
}
...
var Cs = he.unstable_scheduleCallback,
	...
	Bc = he.unstable_shouldYield,
	Hc = he.unstable_requestPaint,
	W = he.unstable_now,
	Wc = he.unstable_getCurrentPriorityLevel,
	Jo = he.unstable_ImmediatePriority,
	xs = he.unstable_UserBlockingPriority,
	Mr = he.unstable_NormalPriority,
	Qc = he.unstable_LowPriority,
...
function kr(e) {
	...
	for (var n = e.targetContainers; 0 < n.length; ) {
		...
		if (t === null) {
			...
			return (n = Zt(t)), n !== null && bo(n), (e.blockedOn = t), !1;
		}
...
function dt(e, n) {
	e.blockedOn === n
    && ((e.blockedOn = null),
    ao || ((ao = !0), he.unstable_scheduleCallback(he.unstable_NormalPriority, nf)));
}
	...
	if (Ir) {
		...
		if (l === null) {
			...
			for (; l !== null; ) {
				...
				if ((o !== null && Ls(o), (o = co(e, n, t, r)), o === null && Dl(e, n, r, Fr, t), o === l)) {
					break;
				}
...
var ot = {
	...
	Ju = ge(tl),
	of = $({}, tl, {dataTransfer: 0}),
	uf = ge(of),
	sf = $({}, Gt, {relatedTarget: 0}),
	Nl = ge(sf),
	af = $({}, ot, {animationName: 0, elapsedTime: 0, pseudoElement: 0}),
	cf = ge(af),
	ff = $({}, ot, {
...
var gf = $({}, Gt, {
	...
	Ef = ge(Sf),
	_f = $({}, ot, {propertyName: 0, elapsedTime: 0, pseudoElement: 0}),
	Cf = ge(_f),
	xf = $({}, tl, {
		deltaX: function (e) {
...
var zf = He && 'TextEvent' in window && !_t,
	Fs = He && (!lu || (_t && 8 < _t && 11 >= _t)),
	ei = ' ',
	ni = !1;
...
function As(e, n, t, r) {
	...
	(n = jr(n, 'onChange')),
	0 < n.length
      && ((t = new tu('onChange', 'change', null, t, r)), e.push({event: t, listeners: n}));
}
...
function Vs(e) {
	if (e.propertyName === 'value' && rl(Ft)) {
		...
		As(n, Ft, e, Zo(e)), ks(Of, n);
	}
}

function Df(e, n, t) {
	e === 'focusin'
		? (li(), (Ct = n), (Ft = t), Ct.attachEvent('onpropertychange', Vs))
		: e === 'focusout' && li();
}
	...
	ks(function () {
			...
			if (p !== void 0) {
				...
				for (var a = c, d; a !== null; ) {
					...
					if (
						(d.tag === 5
              && h !== null
              && ((d = h), f !== null && ((h = Ot(a, f)), h != null && k.push(At(a, h, d)))),
						F)
					) {
						break;
					}
		...
		if (!(n & 7)) {
			e: {
				if (
					...
					p && t !== lo && (w = t.relatedTarget || t.fromElement) && (kn(w) || w[We]))
				) {
					break e;
				}
          ...
          g !== w)
              ...
              && ((k = bu), (h = 'onPointerLeave'), (f = 'onPointerEnter'), (a = 'pointer')),
						(F = g == null ? p : Un(g)),
						(d = w == null ? p : Un(w)),
			...
			switch (((C = c ? Un(c) : window), e)) {
				case 'focusin':
					(ti(C) || C.contentEditable === 'true') && ((Fn = C), (fo = c), (xt = null));
					break;
				case 'focusout':
					xt = fo = Fn = null;
					break;
        ...
        && (Fs
          ...
          && (In || P !== 'onCompositionStart'
          	...
          	: ((en = v), (nu = 'value' in en ? en.value : en.textContent), (In = !0))),
        (C = jr(c, P)),
        0 < C.length
          && ((P = new qu(P, e, null, t, v)),
...
function ea(e, n, t) {
	(we[ke++] = $e), (we[ke++] = Ve), (we[ke++] = Pn), (Pn = e);
	var r = $e;
...
function iu(e) {
	for (; e === Vr; ) {
		(Vr = $n[--Vn]), ($n[Vn] = null), (Br = $n[--Vn]), ($n[Vn] = null);
	}
	...
	switch (e.tag) {
		...
		case 13:
			return (
				...
				n !== null
					? ((t = Pn !== null ? {id: $e, overflow: Ve} : null),
	...
	if (j) {
		...
		if (n) {
			...
			if (!hi(e, n)) {
				...
				n && hi(e, n) ? na(r, t) : ((e.flags = (e.flags & -4097) | 2), (j = !1), (ve = e));
			}
		} else {
			if (ko(e)) {
				throw Error(y(418));
...
function fr(e) {
	...
	if ((yi(e), e.tag === 13)) {
		...
		me = ve ? on(e.stateNode.nextSibling) : null;
	}
...
function ra(e) {
	...
	function s(f, a, d, h) {
		...
		return E === Dn
			...
			: a !== null
          && (a.elementType === E
            || (typeof E == 'object' && E !== null && E.$$typeof === Ze && gi(E) === a.type))
	...
	function w(f, a, d, h) {
		...
		if (P === d.length) {
			return t(f, x), j && gn(f, P), E;
		}

		if (x === null) {
			for (; P < d.length; P++) {
				(x = m(f, d[P], h)),
				x !== null && ((a = o(x, a, P)), C === null ? (E = x) : (C.sibling = x), (C = x));
			}
	...
	function k(f, a, d, h) {
		...
		if (x === null) {
			for (; !T.done; P++, T = d.next()) {
				(T = m(f, T.value, h)),
				T !== null && ((a = o(T, a, P)), C === null ? (E = T) : (C.sibling = T), (C = T));
			}
						...
						for (var E = d.key, C = a; C !== null; ) {
							if (C.key === E) {
								if (((E = d.type), E === Dn)) {
									...
									C.elementType === E
                  || (typeof E == 'object' && E !== null && E.$$typeof === Ze && gi(E) === C.type)
								) {
									t(f, C.sibling),
									(a = l(C, d.props)),
									(a.ref = mt(f, C, d)),
...
function gu(e, n, t, r, l, o) {
	if (
		...
		do {
			...
			(o += 1), (G = K = null), (n.updateQueue = null), (Cr.current = od), (e = t(r, l));
		} while (Pt);
	}
		...
		do {
          ...
          && (s = s.next
            = {
				...
				s === null ? ((i = s = m), (u = r)) : (s = s.next = m), (A.lanes |= v), (zn |= v);
			}
...
function ka(e, n) {
	...
	return r !== null && n !== null && yu(n, r[1]) ? r[0] : ((t.memoizedState = [e, n]), e);
}
...
function Ea(e, n, t) {
	return Nn & 21
		? (Oe(t, n) || ((t = Ns()), (A.lanes |= t), (zn |= t), (e.baseState = !0)), n)
		...
		if (e.lanes === 0 && (o === null || o.lanes === 0) && ((o = n.lastRenderedReducer), o !== null)) {
			try {
				...
				if (((l.hasEagerState = !0), (l.eagerState = i), Oe(i, u))) {
					...
					s === null ? ((l.next = l), du(n)) : ((l.next = s.next), (s.next = l)),
					(n.interleaved = l);
...
function Ra(e, n, t) {
	...
	if (r.mode === 'hidden') {
		...
		o !== null ? ((r = o.baseLanes | t), (n.memoizedState = null)) : (r = t), M(Wn, pe), (pe |= r);
	}
...
function Ti(e, n, t, r, l) {
	...
	if ((Gn(n, l), n.stateNode === null)) {
		Pr(e, n), Na(n, t, r), Co(n, t, r, l), (r = !0);
	} else if (e === null) {
		var u = n.stateNode,
			i = n.memoizedProps;
...
function sd(e, n, t, r, l, o, u) {
	...
	if (((i = (u & e.childLanes) !== 0), ae || i)) {
		if (((r = Z), r !== null)) {
			...
			l !== 0 && l !== o.retryLane && ((o.retryLane = l), Qe(e, l), Re(r, e, l, -1));
		}

		return zu(), (r = Vl(Error(y(421)))), pr(e, n, u, r);
	}
...
function cd(e, n, t) {
	...
	switch ((iu(n), n.tag)) {
		...
		case 13:
            ...
            && r
            && ((n.child.flags |= 8192),
            n.mode & 1 && (e === null || U.current & 1 ? Y === 0 && (Y = 3) : zu())),
...
function Aa(e) {
	...
	e.tag === 5
      && ((n = e.stateNode),
      n !== null && (delete n[Ie], delete n[$t], delete n[go], delete n[Gf], delete n[Zf])),
	(e.stateNode = null),
	(e.return = null),
	(e.dependencies = null),
...
function Ba(e, n) {
	...
	switch (e.tag) {
		...
		case 13:
          ...
          !o || (l.alternate !== null && l.alternate.memoizedState !== null) || (xu = W())),
			r & 4 && Ii(e);
...
function an(e) {
	return e.mode & 1
		? R & 2 && q !== 0
			...
			: qf.transition !== null
				? (zr === 0 && (zr = Ns()), zr)
				: ((e = O), e !== 0 || ((e = window.event), (e = e === void 0 ? 16 : Ds(e.type))), e)
		: 1;
}
...
function de(e, n) {
	...
	if (r === 0) {
		...
		if ((t != null && Yu(t), n === 1)) {
			e.tag === 0 ? Jf(Ai.bind(null, e)) : bs(Ai.bind(null, e)),
			Yf(function () {
				!(R & 6) && vn();
			}),
			(t = null);
...
function Wa(e, n) {
	...
	if (r & 30 || r & e.expiredLanes || n) {
		...
		cu(), (Gr.current = o), (R = l), Q !== null ? (n = 0) : ((Z = null), (q = 0), (n = Y));
	}

	if (n !== 0) {
		if ((n === 2 && ((l = so(e)), l !== 0 && ((r = l), (n = jo(e, l)))), n === 1)) {
			throw ((t = Kt), _n(e, 0), be(e, r), de(e, W()), t);
		}
		...
		if (n === 6) {
			...
			if (
				...
				!(r & 30)
          && !hd(l)
          && ((n = qr(e, r)), n === 2 && ((o = so(e)), o !== 0 && ((r = o), (n = jo(e, o)))), n === 1))
			) {
				throw ((t = Kt), _n(e, 0), be(e, r), de(e, W()), t);
			}
			...
			switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
				...
				case 2:
					...
					break;
				case 3:
					if ((be(e, r), (r & 130023424) === r && ((n = xu + 500 - W()), 10 < n))) {
						if (Dr(e, 0) !== 0) {
							break;
						}
...
function Ai(e) {
	...
	if (t === 1) {
		throw ((t = Kt), _n(e, 0), be(e, n), de(e, W()), t);
	}
	...
	return (
		(e.finishedWork = e.current.alternate), (e.finishedLanes = n), wn(e, se, Ue), de(e, W()), null
	);
}
		...
		try {
			...
			e: {
				...
				if (
					...
					if (g !== null) {
						(g.flags &= -257), Ni(g, u, i, o, n), g.mode & 1 && xi(o, c, n), (n = g), (s = c);
						var w = n.updateQueue;
					...
					if (F !== null) {
						!(F.flags & 65536) && (F.flags |= 256), Ni(F, u, i, o, n), su(tt(s, i));
						break e;
					}
				}
...
function Ya(e) {
	...
	(e.memoizedProps = e.pendingProps), n === null ? Xa(e) : (Q = n), (_u.current = null);
}
...
function kd(e, n, t) {
	...
	Z === e
      && (q & t) === t
      && (Y === 4 || (Y === 3 && (q & 130023424) === q && 500 > W() - xu) ? _n(e, 0) : (Cu |= t)),
	de(e, n);
}
...
Za = function (e, n, t) {
	...
	switch (((n.lanes = 0), n.tag)) {
		...
		case 14:
			return (r = n.type), (l = Ne(r, n.pendingProps)), (l = Ne(r.type, l)), Li(e, n, r, l, t);
		case 15:
	...
	if (((r = e), typeof e == 'function')) {
		...
		e: switch (e) {
			...
			case Yo:
				...
				break;
			case Yl:
				return (e = Se(12, t, n, l | 2)), (e.elementType = Yl), (e.lanes = o), e;
			case Xl:
	...
	switch (e.tag) {
		case 3:
			...
			if (n.current.memoizedState.isDehydrated) {
				...
				t !== 0 && (qo(n, t | 1), de(n, W()), !(R & 6) && ((rt = W() + 500), vn()));
			}
...
gs = Pu;
ws = Ln;
var Ld = {usingClientEntryPoint: !1, Events: [Zt, Un, ol, hs, ys, Pu]},
	ht = {
...
function jd() {
	return (
		...
		Ge.jsx('div', {
			className: yr.App,
			children: Ge.jsxs('header', {
				className: yr.AppHeader,
				children: [
					Ge.jsx('img', {alt: 'logo', className: yr.AppLogo, src: Fd}),
					Ge.jsxs('p', {
						children: [
							'Edit',
							' ',
...
const Ud = Ql.createRoot(document.getElementById('root'));

Ud.render(Ge.jsx(wc.StrictMode, {children: Ge.jsx(jd, {})}));
//# sourceMappingURL=index-D9IWbfIq.js.map
